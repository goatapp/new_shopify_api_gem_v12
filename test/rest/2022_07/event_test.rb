...
class Event202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?since_id=164748010")
      .with(
    ...
    NewShopifyAPI::Event.all(
      since_id: "164748010",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?since_id=164748010")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?filter=Product&verb=destroy")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?filter=Product&verb=destroy")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/orders/450789469/events.json?limit=1&since_id=164748010")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/orders/450789469/events.json?limit=1&since_id=164748010")
  end
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/orders/450789469/events.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/orders/450789469/events.json")
  end
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?filter=Product%2COrder")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?filter=Product%2COrder")
  end
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/921728736/events.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/921728736/events.json")
  end
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?created_at_min=2008-01-10+12%3A30%3A00%2B00%3A00")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events.json?created_at_min=2008-01-10+12%3A30%3A00%2B00%3A00")
  end
  ...
  def test_9()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events/677313116.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Event.find(
      id: 677313116,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events/677313116.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Event.count

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events/count.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events/count.json?created_at_min=2008-01-10T13%3A00%3A00%2B00%3A00")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/events/count.json?created_at_min=2008-01-10T13%3A00%3A00%2B00%3A00")
  end
