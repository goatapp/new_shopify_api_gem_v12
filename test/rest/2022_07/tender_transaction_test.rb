...
class TenderTransaction202207Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/tender_transactions.json?since_id=1011222833")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/tender_transactions.json?since_id=1011222833")
  end
