...
class Variant202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_2()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants.json?presentment_currencies=USD%2CCAD")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Variant.count(
      product_id: 632910392,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants/count.json")
  end
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Variant.find(
      id: 808950810,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/variants/808950810.json")
  end
  ...
  def test_6()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "variant" => hash_including({"image_id" => 562641783}) }
      )
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "sku" => "IPOD2008PINK", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "fulfillment_service" => "manual", "inventory_management" => "shopify", "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2022-10-03T12:44:45-04:00", "updated_at" => "2022-10-03T12:50:21-04:00", "taxable" => true, "barcode" => "1234_pink", "grams" => 567, "image_id" => 562641783, "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "requires_shipping" => true, "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810"}}), headers: {})

    variant = NewShopifyAPI::Variant.new
    variant.id = 808950810
    variant.image_id = 562641783
    variant.save

    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/variants/808950810.json")
  end
  ...
  def test_7()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/variants/808950810.json")
      ...
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 808950810, "product_id" => 632910392, "title" => "Pink", "price" => "199.00", "sku" => "IPOD2008PINK", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "fulfillment_service" => "manual", "inventory_management" => "shopify", "option1" => "Pink", "option2" => nil, "option3" => nil, "created_at" => "2022-10-03T12:44:45-04:00", "updated_at" => "2022-10-03T12:50:38-04:00", "taxable" => true, "barcode" => "1234_pink", "grams" => 567, "image_id" => 562641783, "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "199.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "requires_shipping" => true, "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810"}}), headers: {})
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/variants/808950810.json")
      ...
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 808950810, "product_id" => 632910392, "title" => "Not Pink", "price" => "99.00", "sku" => "IPOD2008PINK", "position" => 1, "inventory_policy" => "continue", "compare_at_price" => nil, "fulfillment_service" => "manual", "inventory_management" => "shopify", "option1" => "Not Pink", "option2" => nil, "option3" => nil, "created_at" => "2022-10-03T12:44:45-04:00", "updated_at" => "2022-10-03T12:50:49-04:00", "taxable" => true, "barcode" => "1234_pink", "grams" => 567, "image_id" => 562641783, "weight" => 1.25, "weight_unit" => "lb", "inventory_item_id" => 808950810, "inventory_quantity" => 10, "old_inventory_quantity" => 10, "presentment_prices" => [{"price" => {"amount" => "99.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "requires_shipping" => true, "admin_graphql_api_id" => "gid://shopify/ProductVariant/808950810"}}), headers: {})
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "variant" => hash_including({"image_id" => 850703190, "option1" => "Purple"}) }
      )
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 1070325019, "product_id" => 632910392, "title" => "Purple", "price" => "0.00", "sku" => "", "position" => 5, "inventory_policy" => "deny", "compare_at_price" => nil, "fulfillment_service" => "manual", "inventory_management" => "shopify", "option1" => "Purple", "option2" => nil, "option3" => nil, "created_at" => "2022-10-03T12:50:00-04:00", "updated_at" => "2022-10-03T12:50:00-04:00", "taxable" => true, "barcode" => nil, "grams" => 0, "image_id" => 850703190, "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325019, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "requires_shipping" => true, "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325019"}}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants.json")
  end
  ...
  def test_11()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants.json")
      ...
      .to_return(status: 200, body: JSON.generate({"variant" => {"id" => 1070325024, "product_id" => 632910392, "title" => "Blue", "price" => "0.00", "sku" => "", "position" => 5, "inventory_policy" => "deny", "compare_at_price" => nil, "fulfillment_service" => "manual", "inventory_management" => "shopify", "option1" => "Blue", "option2" => nil, "option3" => nil, "created_at" => "2022-10-03T12:50:35-04:00", "updated_at" => "2022-10-03T12:50:35-04:00", "taxable" => true, "barcode" => nil, "grams" => 0, "image_id" => nil, "weight" => 0.0, "weight_unit" => "lb", "inventory_item_id" => 1070325024, "inventory_quantity" => 0, "old_inventory_quantity" => 0, "presentment_prices" => [{"price" => {"amount" => "0.00", "currency_code" => "USD"}, "compare_at_price" => nil}], "requires_shipping" => true, "admin_graphql_api_id" => "gid://shopify/ProductVariant/1070325024"}}), headers: {})
  ...
  def test_12()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Variant.delete(
      product_id: 632910392,
      id: 808950810,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/products/632910392/variants/808950810.json")
  end
