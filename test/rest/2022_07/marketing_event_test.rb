...
class MarketingEvent202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events.json")
  end
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/count.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532.json")
  end
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532.json")
  end
  ...
  def test_6()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532.json")
  end
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532/engagements.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-07/marketing_events/998730532/engagements.json")
  end
