...
class DeprecatedApiCall202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/deprecated_api_calls.json")
      .with(
    ...
    NewShopifyAPI::DeprecatedApiCall.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/deprecated_api_calls.json")
  end
