...
class Asset202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/themes/828155753/assets.json")
      .with(
    ...
    NewShopifyAPI::Asset.all(
      theme_id: 828155753,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/themes/828155753/assets.json")
  end
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
  end
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Asset.delete(
      theme_id: 828155753,
      asset: {"key" => "assets/bg-body.gif"},
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
  end
