...
class CustomerAddress202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses.json?limit=1")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses.json?limit=1")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/207119551.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/207119551.json")
  end
  ...
  def test_4()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/207119551.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "address" => hash_including({"zip" => "90210"}) }
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/207119551.json")
  end
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/1053317293.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/1053317293.json")
  end
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses.json")
  end
  ...
  def test_7()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/set.json?address_ids%5B%5D=1053317292&operation=destroy")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/set.json?address_ids%5B%5D=1053317292&operation=destroy")
  end
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/1053317290/default.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/customers/207119551/addresses/1053317290/default.json")
  end
