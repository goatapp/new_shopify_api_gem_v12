...
class ApplePayCertificate202207Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/apple_pay_certificates/1068938276.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/apple_pay_certificates/1068938276.json")
  end
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/apple_pay_certificates/1068938275/csr.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/apple_pay_certificates/1068938275/csr.json")
  end
