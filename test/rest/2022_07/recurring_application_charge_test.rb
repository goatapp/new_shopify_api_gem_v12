...
class RecurringApplicationCharge202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_5()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/recurring_application_charges/455696195.json")
  end
  ...
  def test_6()
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/recurring_application_charges/455696195.json")
  end
  ...
  def test_9()
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/recurring_application_charges/455696195/customize.json?recurring_application_charge%5Bcapped_amount%5D=200")
  end
