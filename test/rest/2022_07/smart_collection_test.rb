...
class SmartCollection202207Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"smart_collections" => [{"id" => 482865238, "handle" => "smart-ipods", "title" => "Smart iPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2022-10-03T13:07:13-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664816833"}}]}), headers: {})

    NewShopifyAPI::SmartCollection.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json?since_id=482865238")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"smart_collections" => [{"id" => 1063001333, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2022-10-03T13:16:25-04:00", "body_html" => nil, "published_at" => "2022-10-03T13:16:25-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "title", "relation" => "starts_with", "condition" => "iPod"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001333"}]}), headers: {})

    NewShopifyAPI::SmartCollection.all(
      since_id: "482865238",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json?since_id=482865238")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json?product_id=632910392")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json?ids=482865238%2C1063001348")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"smart_collections" => [{"id" => 1063001348, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T13:18:29-04:00", "body_html" => nil, "published_at" => "2022-10-03T13:18:29-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "vendor", "relation" => "equals", "condition" => "Apple"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001348"}, {"id" => 482865238, "handle" => "smart-ipods", "title" => "Smart iPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2022-10-03T13:07:13-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664816833"}}]}), headers: {})

    NewShopifyAPI::SmartCollection.all(
      ids: "482865238,1063001348",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json?ids=482865238%2C1063001348")
  end
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json")
      .with(
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"id" => 1063001332, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T13:16:20-04:00", "body_html" => nil, "published_at" => "2022-10-03T13:16:20-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "vendor", "relation" => "equals", "condition" => "Apple"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001332"}}), headers: {})

    smart_collection = NewShopifyAPI::SmartCollection.new
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json")
  end
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"id" => 1063001346, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2022-10-03T13:18:22-04:00", "body_html" => nil, "published_at" => "2022-10-03T13:18:22-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "title", "relation" => "starts_with", "condition" => "iPod"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001346"}}), headers: {})
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"id" => 1063001347, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T13:18:27-04:00", "body_html" => nil, "published_at" => nil, "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "vendor", "relation" => "equals", "condition" => "Apple"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001347"}}), headers: {})
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::SmartCollection.count

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/count.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/count.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/count.json?product_id=632910392")
  end
  ...
  def test_12()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::SmartCollection.find(
      id: 482865238,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
  end
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "smart_collection" => hash_including({"published" => true}) }
      )
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"title" => "Smart iPods", "handle" => "smart-ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 482865238, "published_at" => "2022-10-03T13:15:44-04:00", "updated_at" => "2022-10-03T13:15:45-04:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2022-10-03T13:07:13-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664816833"}}}), headers: {})
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
  end
  ...
  def test_16()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"body_html" => "<p>5000 songs in your pocket</p>", "title" => "Smart iPods", "handle" => "smart-ipods", "id" => 482865238, "updated_at" => "2022-10-03T13:16:36-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2022-10-03T13:07:13-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664816833"}}}), headers: {})
  ...
  def test_17()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "smart_collection" => hash_including({"image" => "", "updated_at" => "2022-10-03T13:17:08-04:00", "title" => "Smart iPods", "handle" => "smart-ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238"}) }
      )
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"body_html" => "<p>The best selling ipod ever</p>", "handle" => "smart-ipods", "updated_at" => "2022-10-03T13:17:09-04:00", "id" => 482865238, "sort_order" => "manual", "title" => "Smart iPods", "disjunctive" => false, "template_suffix" => nil, "published_at" => "2008-02-01T19:00:00-05:00", "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238"}}), headers: {})
  ...
  def test_18()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"title" => "Smart iPods", "handle" => "smart-ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 482865238, "published_at" => nil, "updated_at" => "2022-10-03T13:17:23-04:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2022-10-03T13:07:13-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664816833"}}}), headers: {})
  ...
  def test_19()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::SmartCollection.delete(
      id: 482865238,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238.json")
  end
  ...
  def test_20()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392")
  end
  ...
  def test_21()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238/order.json?sort_order=alpha-desc")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-07/smart_collections/482865238/order.json?sort_order=alpha-desc")
  end
