...
class Event202201Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_2()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events.json?filter=Product&verb=destroy")
  end
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/products/921728736/events.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/products/921728736/events.json")
  end
  ...
  def test_9()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events/677313116.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events/677313116.json")
  end
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events/count.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events/count.json?created_at_min=2008-01-10T13%3A00%3A00%2B00%3A00")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/events/count.json?created_at_min=2008-01-10T13%3A00%3A00%2B00%3A00")
  end
