...
class Payout202201Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/shopify_payments/payouts.json?date_max=2012-11-12")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/shopify_payments/payouts.json?date_max=2012-11-12")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/shopify_payments/payouts.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/shopify_payments/payouts.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/shopify_payments/payouts/623721858.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/shopify_payments/payouts/623721858.json")
  end
