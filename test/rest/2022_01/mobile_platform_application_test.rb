...
class MobilePlatformApplication202201Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications.json")
      .with(
  ...
  def test_2()
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066175996.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066175996.json")
  end
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066175997.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "mobile_platform_application" => hash_including({"application_id" => "A1B2.ca.domain.app", "platform" => "ios", "created_at" => "2022-10-03T13:14:07-04:00", "updated_at" => "2022-10-03T13:14:07-04:00", "sha256_cert_fingerprints" => [], "enabled_universal_or_app_links" => true, "enabled_shared_webcredentials" => true}) }
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066175997.json")
  end
  ...
  def test_6()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176002.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176002.json")
  end
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176003.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/mobile_platform_applications/1066176003.json")
  end
