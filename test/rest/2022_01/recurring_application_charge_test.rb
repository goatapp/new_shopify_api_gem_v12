...
class RecurringApplicationCharge202201Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges.json")
      .with(
    ...
    recurring_application_charge = NewShopifyAPI::RecurringApplicationCharge.new
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges.json")
  end
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges/455696195.json")
      .with(
    ...
    NewShopifyAPI::RecurringApplicationCharge.find(
      id: 455696195,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges/455696195.json")
  end
  ...
  def test_6()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges/455696195.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::RecurringApplicationCharge.delete(
      id: 455696195,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges/455696195.json")
  end
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges.json?since_id=455696195")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::RecurringApplicationCharge.all(
      since_id: "455696195",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges.json?since_id=455696195")
  end
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges.json")
  end
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges/455696195/customize.json?recurring_application_charge%5Bcapped_amount%5D=200")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/recurring_application_charges/455696195/customize.json?recurring_application_charge%5Bcapped_amount%5D=200")
  end
