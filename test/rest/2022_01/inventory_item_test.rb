...
class InventoryItem202201Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/inventory_items.json?ids=808950810%2C39072856%2C457924702")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/inventory_items.json?ids=808950810%2C39072856%2C457924702")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/inventory_items/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/inventory_items/808950810.json")
  end
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/inventory_items/808950810.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/inventory_items/808950810.json")
  end
