...
class AndroidPayKey202201Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/android_pay_keys.json")
      .with(
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/android_pay_keys/964811894.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/android_pay_keys/964811894.json")
  end
  ...
  def test_3()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/android_pay_keys/964811896.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/android_pay_keys/964811896.json")
  end
