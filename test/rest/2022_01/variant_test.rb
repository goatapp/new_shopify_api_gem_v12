...
class Variant202201Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/products/632910392/variants.json?since_id=49148385")
  end
  ...
  def test_2()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/products/632910392/variants.json?presentment_currencies=USD%2CCAD")
  end
  ...
  def test_4()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/products/632910392/variants/count.json")
  end
  ...
  def test_5()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/variants/808950810.json")
  end
  ...
  def test_12()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/products/632910392/variants/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/products/632910392/variants/808950810.json")
  end
