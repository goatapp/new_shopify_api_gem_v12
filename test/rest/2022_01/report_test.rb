...
class Report202201Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json")
      .with(
    ...
    NewShopifyAPI::Report.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?updated_at_min=2005-07-31+15%3A57%3A11+EDT+-04%3A00")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?updated_at_min=2005-07-31+15%3A57%3A11+EDT+-04%3A00")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?ids=517154478")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?ids=517154478")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?since_id=123")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?since_id=123")
  end
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?fields=id%2Cshopify_ql")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json?fields=id%2Cshopify_ql")
  end
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json")
      .with(
    ...
    report = NewShopifyAPI::Report.new
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/reports.json")
  end
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Report.find(
      id: 517154478,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json")
  end
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json?fields=id%2Cshopify_ql")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json?fields=id%2Cshopify_ql")
  end
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json")
  end
  ...
  def test_10()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Report.delete(
      id: 517154478,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/reports/517154478.json")
  end
