...
class DraftOrder202201Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders.json")
  end
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders.json")
      .with(
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539.json")
  end
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539.json")
  end
  ...
  def test_12()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539.json")
  end
  ...
  def test_13()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_14()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539/send_invoice.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539/send_invoice.json")
  end
  ...
  def test_16()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539/complete.json?payment_pending=true")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539/complete.json?payment_pending=true")
  end
  ...
  def test_17()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539/complete.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-01/draft_orders/994118539/complete.json")
  end
