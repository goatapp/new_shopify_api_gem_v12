...
class Country202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries.json?since_id=359115488")
      .with(
    ...
    NewShopifyAPI::Country.all(
      since_id: "359115488",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries.json?since_id=359115488")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Country.count

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries/count.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Country.find(
      id: 879921427,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/countries/879921427.json")
  end
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/countries/879921427.json")
      .with(
    ...
    country = NewShopifyAPI::Country.new
    country.id = 879921427
    country.tax = 0.05
    country.save

    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-04/countries/879921427.json")
  end
  ...
  def test_6()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::Country.delete(
      id: 879921427,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/countries/879921427.json")
  end
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/countries.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "country" => hash_including({"code" => "FR"}) }
      )
      .to_return(status: 200, body: JSON.generate({"country" => {"id" => 1070231510, "name" => "France", "code" => "FR", "tax_name" => "TVA", "tax" => 0.2, "provinces" => []}}), headers: {})

    country = NewShopifyAPI::Country.new
    country.code = "FR"
    country.save

    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/countries.json")
  end
