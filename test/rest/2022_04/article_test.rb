...
class Article202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json?since_id=134645308")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json?since_id=134645308")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/count.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json")
  end
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json")
  end
  ...
  def test_12()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/134645308.json")
  end
  ...
  def test_13()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles.json")
  end
  ...
  def test_18()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/articles/authors.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/articles/authors.json")
  end
  ...
  def test_19()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/articles/tags.json?limit=1&popular=1")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/articles/tags.json?limit=1&popular=1")
  end
  ...
  def test_20()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/articles/tags.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/articles/tags.json")
  end
  ...
  def test_21()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/tags.json?limit=1&popular=1")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/tags.json?limit=1&popular=1")
  end
  ...
  def test_22()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/tags.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/blogs/241253187/articles/tags.json")
  end
