...
class FulfillmentRequest202204Test < Test::Unit::TestCase
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000798/fulfillment_request.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000798/fulfillment_request.json")
  end
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000803/fulfillment_request.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000803/fulfillment_request.json")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000801/fulfillment_request/accept.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000801/fulfillment_request/accept.json")
  end
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000802/fulfillment_request/reject.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_orders/1046000802/fulfillment_request/reject.json")
  end
