...
class FulfillmentService202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services.json")
      .with(
    ...
    NewShopifyAPI::FulfillmentService.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services.json?scope=all")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services.json?scope=all")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services.json")
      .with(
      ...
      .to_return(status: 200, body: JSON.generate({"fulfillment_service" => {"id" => 1061774487, "name" => "Jupiter Fulfillment", "email" => nil, "service_name" => "Jupiter Fulfillment", "handle" => "jupiter-fulfillment", "fulfillment_orders_opt_in" => false, "include_pending_stock" => false, "provider_id" => nil, "location_id" => 1072404542, "callback_url" => "http://google.com/", "tracking_support" => true, "inventory_management" => true, "admin_graphql_api_id" => "gid://shopify/ApiFulfillmentService/1061774487"}}), headers: {})

    fulfillment_service = NewShopifyAPI::FulfillmentService.new
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services/755357713.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::FulfillmentService.find(
      id: 755357713,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services/755357713.json")
  end
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services/755357713.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services/755357713.json")
  end
  ...
  def test_6()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services/755357713.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::FulfillmentService.delete(
      id: 755357713,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/fulfillment_services/755357713.json")
  end
