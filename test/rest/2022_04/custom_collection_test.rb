...
class CustomCollection202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json?ids=395646240%2C691652237%2C841564295")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json?ids=395646240%2C691652237%2C841564295")
  end
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json?product_id=632910392")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json?since_id=841564295")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"custom_collections" => [{"id" => 1063001328, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:24:03-04:00", "body_html" => nil, "published_at" => "2022-10-03T12:24:03-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001328"}]}), headers: {})

    NewShopifyAPI::CustomCollection.all(
      since_id: "841564295",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json?since_id=841564295")
  end
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"title" => "Macbooks", "published" => false}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001313, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:10-04:00", "body_html" => nil, "published_at" => nil, "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001313"}}), headers: {})

    custom_collection = NewShopifyAPI::CustomCollection.new
    custom_collection.title = "Macbooks"
    custom_collection.published = false
    custom_collection.save

    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json")
  end
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001315, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2022-10-03T12:23:13-04:00", "body_html" => nil, "published_at" => "2022-10-03T12:23:13-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001315"}}), headers: {})
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001319, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:29-04:00", "body_html" => nil, "published_at" => "2022-10-03T12:23:29-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001319"}}), headers: {})
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001322, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:35-04:00", "body_html" => nil, "published_at" => "2022-10-03T12:23:34-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001322", "image" => {"created_at" => "2022-10-03T12:23:34-04:00", "alt" => "Rails Logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20221003-23488-gz22my.gif?v=1664814215"}}}), headers: {})
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001324, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2022-10-03T12:23:44-04:00", "body_html" => nil, "published_at" => "2022-10-03T12:23:44-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001324"}}), headers: {})
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/count.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::CustomCollection.count(
      product_id: "632910392",
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/count.json?product_id=632910392")
  end
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/count.json")
  end
  ...
  def test_12()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 841564295, "handle" => "ipods", "title" => "IPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "products_count" => 1, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:15:55-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664813755"}}}), headers: {})

    NewShopifyAPI::CustomCollection.find(
      id: 841564295,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
  end
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"body_html" => "<p>5000 songs in your pocket</p>"}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>5000 songs in your pocket</p>", "title" => "IPods", "handle" => "ipods", "id" => 841564295, "updated_at" => "2022-10-03T12:22:50-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:15:55-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664813755"}}}), headers: {})
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
  end
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2022-10-03T12:23:02-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:23:02-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1664814182"}}}), headers: {})
  ...
  def test_15()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2022-10-03T12:23:04-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:15:55-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664813755"}}}), headers: {})
  ...
  def test_16()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => nil, "updated_at" => "2022-10-03T12:23:23-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:15:55-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664813755"}}}), headers: {})
  ...
  def test_17()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => "2022-10-03T12:23:50-04:00", "updated_at" => "2022-10-03T12:23:50-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:15:55-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664813755"}}}), headers: {})
  ...
  def test_18()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"image" => "", "updated_at" => "2022-10-03T12:23:53-04:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>The best selling ipod ever</p>", "handle" => "ipods", "updated_at" => "2022-10-03T12:23:53-04:00", "id" => 841564295, "sort_order" => "manual", "title" => "IPods", "template_suffix" => nil, "published_at" => "2008-02-01T19:00:00-05:00", "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}}), headers: {})
  ...
  def test_19()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2022-10-03T12:23:56-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"alt" => "Rails logo", "created_at" => "2022-10-03T12:23:55-04:00", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20221003-23488-72b9ne.gif?v=1664814236"}}}), headers: {})
  ...
  def test_20()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2022-10-03T12:24:10-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2022-10-03T12:15:55-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1664813755"}}}), headers: {})
  ...
  def test_21()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::CustomCollection.delete(
      id: 841564295,
    )

    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/custom_collections/841564295.json")
  end
