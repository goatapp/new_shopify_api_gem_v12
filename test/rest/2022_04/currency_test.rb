...
class Currency202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/currencies.json")
      .with(
    ...
    NewShopifyAPI::Currency.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/currencies.json")
  end
