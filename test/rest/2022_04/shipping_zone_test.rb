...
class ShippingZone202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/shipping_zones.json")
      .with(
    ...
    NewShopifyAPI::ShippingZone.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/shipping_zones.json")
  end
