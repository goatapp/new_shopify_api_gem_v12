...
class InventoryItem202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/inventory_items.json?ids=808950810%2C39072856%2C457924702")
      .with(
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/inventory_items/808950810.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/inventory_items/808950810.json")
      .with(
