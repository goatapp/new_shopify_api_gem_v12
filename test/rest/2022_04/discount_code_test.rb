...
class DiscountCode202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/discount_codes.json")
      .with(
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/discount_codes.json")
      .with(
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/discount_codes/507328175.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/discount_codes/507328175.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/discount_codes/507328175.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/discount_codes/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/batch.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/batch/173232803.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_9()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/price_rules/507328175/batch/173232803/discount_codes.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
