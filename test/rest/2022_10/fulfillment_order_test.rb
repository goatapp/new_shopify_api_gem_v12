...
class FulfillmentOrder202210Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-10/orders/450789469/fulfillment_orders.json")
      .with(
    ...
    NewShopifyAPI::FulfillmentOrder.all(
      order_id: 450789469,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/orders/450789469/fulfillment_orders.json")
  end
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000786.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::FulfillmentOrder.find(
      id: 1046000786,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000786.json")
  end
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000789/cancel.json")
      .with(
    ...
    fulfillment_order = NewShopifyAPI::FulfillmentOrder.new
    fulfillment_order.id = 1046000789
    fulfillment_order.cancel

    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000789/cancel.json")
  end
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000787/close.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000787/close.json")
  end
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000781/move.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000781/move.json")
  end
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000783/open.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000783/open.json")
  end
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000791/reschedule.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000791/reschedule.json")
  end
  ...
  def test_8()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000794/hold.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000794/hold.json")
  end
  ...
  def test_9()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/set_fulfillment_orders_deadline.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: hash_including({"fulfillment_order_ids" => [1046000793], "fulfillment_deadline" => "2021-05-26T10:00:00-04:00"})
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/set_fulfillment_orders_deadline.json")
  end
  ...
  def test_10()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000792/release_hold.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/fulfillment_orders/1046000792/release_hold.json")
  end
