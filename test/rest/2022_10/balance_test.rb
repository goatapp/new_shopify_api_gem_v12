...
class Balance202210Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-10/shopify_payments/balance.json")
      .with(
    ...
    NewShopifyAPI::Balance.all

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/shopify_payments/balance.json")
  end
