...
class Collect202210Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2022-10/collects.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2022-10/collects.json")
  end
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-10/collects.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/collects.json?product_id=632910392")
  end
  ...
  def test_7()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/collects/count.json?collection_id=841564295")
  end
