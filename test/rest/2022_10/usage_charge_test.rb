...
class UsageCharge202210Test < Test::Unit::TestCase
  ...
  def test_1()
    ...
    usage_charge = NewShopifyAPI::UsageCharge.new
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-10/recurring_application_charges/455696195/usage_charges/1034618210.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    NewShopifyAPI::UsageCharge.find(
      recurring_application_charge_id: 455696195,
      id: 1034618210,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-10/recurring_application_charges/455696195/usage_charges/1034618210.json")
  end
